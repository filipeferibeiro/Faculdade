...
class ItemPage extends StatefulWidget {
  ...
  ItemPage(AppDB db, Dia dia) {
    this.db = db;
    this.dia = dia;
  }

  _ItemPage createState() => _ItemPage(db, dia);
}
                            ...
                            setState(() {
                              try {
                                if (valorControler.text != "0,00") {
                                  AppDB.info.banco -= valorControler.numberValue;
                                  dia.getItens().add(new Item(
                                      null,
                                      nomeControler.text,
                                      valorControler.numberValue));
                                  db.addItem(dia.ID, valorControler.numberValue,
                                      nomeControler.text, dia.getItens().last);
